...
public class Robot extends TimedRobot {
 ...
 // private final ClimbSubsystem m_climb =new ClimbSubsystem();
  ...
  //private final CANSparkMax climb1= new CANSparkMax(Constants.ClimbConstants.climbUstPort, MotorType.kBrushless);
  //private final CANSparkMax climb2= new CANSparkMax(Constants.ClimbConstants.climbUstPort, MotorType.kBrushless);
